...
export default function StatsOverview({
  ...
  const stats = [
    { label: '対象国', value: countryCount, suffix: 'カ国', icon: ICONS.globe },
    { label: '掲載学校', value: schoolCount, suffix: '校', icon: ICONS.school },
    { label: '体験談', value: experienceCount, suffix: '件', icon: ICONS.story },
    { label: '口コミ', value: reviewCount, suffix: '件', icon: ICONS.review },
  ];
