...
export const COUNTRY_PURPOSE_GUIDES: PurposeGuideDefinition[] = [
  ...
  {
    countrySlug: 'costa-rica', purpose: 'study-abroad', sourceArticleId: 'study-costa-rica-complete-guide',
    mergedArticleIds: ['study-costa-rica-complete-guide'],
    redirectFromPaths: ['/countries/costa-rica/cost'],
    coverageAreas: STUDY_COVERAGE,
    allowNoVerifiedExperience: true,
    officialSources: [
      { label: 'DGME — Ley General de Migración y Extranjería 8764', url: 'https://www.migracion.go.cr/Documentos%20compartidos/Leyes/Ley%20General%20de%20Migraci%C3%B3n%20y%20Extranjer%C3%ADa%208764.pdf', supports: '学生・ボランティア区分・期間・就労制限' },
      { label: 'UCR — International Students', url: 'https://oaice.ucr.ac.cr/informacion-para-estudiantes-internacionales', supports: '学士・大学院・交換留学の入口と出願条件' },
      { label: 'UCR — Fact Sheet 2027', url: 'https://oaice.ucr.ac.cr/sites/default/files/2026-07/Fact%20Sheet%20UCR%20English%202027..pdf', supports: 'GPA・語学・費用・資金・住居・保険' },
      { label: 'CONESUP — Universidades autorizadas', url: 'https://conesup.mep.go.cr/lista_universidades', supports: '私立大学の認可確認' },
      { label: 'SINAES — Preguntas frecuentes', url: 'https://www.sinaes.ac.cr/preguntas-frecuentes/', supports: '課程認可と品質認証の区別' },
      { label: '外務省 — コスタリカ危険情報', url: 'https://www.anzen.mofa.go.jp/info/pcinfectionspothazardinfo_247.html', supports: '地域別危険情報と犯罪対策' },
    ],
  },
  {
    countrySlug: 'fiji', purpose: 'study-abroad', sourceArticleId: 'study-fiji-complete-guide-20260831',
    mergedArticleIds: ['study-fiji-complete-guide-20260831'],
    redirectFromPaths: ['/countries/fiji/cost'],
    coverageAreas: STUDY_COVERAGE,
    allowNoVerifiedExperience: true,
    officialSources: [
      { label: 'Fiji Immigration — Student Permit', url: 'https://www.immigration.gov.fj/student-permit-application/', supports: '学生許可・対象課程・必要書類・審査目安' },
      { label: 'Fiji Immigration — Short Study Authority', url: 'https://www.immigration.gov.fj/authority-to-work-or-study-while-on-a-visitors-permit/', supports: '12週間以内の短期就学手続' },
      { label: 'Fiji Immigration — Frequently Asked Questions', url: 'https://www.immigration.gov.fj/frequently-asked-questions/', supports: '学生許可の就労制限と実習条件' },
      { label: 'Fiji Higher Education Commission — Registered HEIs', url: 'https://hec.org.fj/registered-heis/', supports: '登録教育機関の確認' },
      { label: 'USP — International Student Tuition Fees 2026', url: 'https://www.usp.ac.fj/handbookandcalendar2026/2026-fees-schedule/international-student-tuition-fees-2026/', supports: '語学・基礎・学位・交換留学の学費例' },
      { label: 'USP — Non-Tuition Fees 2026', url: 'https://www.usp.ac.fj/handbookandcalendar2026/2026-fees-schedule/non-tuition-fees-and-charges-2026/', supports: '寮・健康・教材・生活予算の例' },
    ],
  },
  {
    countrySlug: 'hong-kong', purpose: 'study-abroad', sourceArticleId: 'study-hong-kong-complete-guide',
    mergedArticleIds: ['study-hong-kong-complete-guide'],
    coverageAreas: STUDY_COVERAGE,
    allowNoVerifiedExperience: true,
    officialSources: [
      { label: 'Hong Kong Immigration Department — Students', url: 'https://www.immd.gov.hk/eng/services/visas/study.html', supports: '学生査証・資力・スポンサー・申請書類・審査目安' },
      { label: 'Hong Kong Immigration Department — Study FAQ', url: 'https://www.immd.gov.hk/eng/faq/imm-policy-study.html', supports: 'NOL・就労・交換・インターン条件' },
      { label: 'Hong Kong Immigration Department — IANG', url: 'https://www.immd.gov.hk/eng/services/visas/IANG.html', supports: '卒業後の滞在・就労条件' },
      { label: 'Education Bureau — Higher education institutions', url: 'https://www.edb.gov.hk/en/edu-system/postsecondary/local-higher-edu/institutions/index.html', supports: '高等教育機関の確認' },
      { label: 'The University of Hong Kong — Fees', url: 'https://www.admissions.hku.hk/zh-hant/fees-and-scholarships/fees', supports: '2026/27学費・住居・生活費の例' },
      { label: 'The Hong Kong Polytechnic University — Fees', url: 'https://www.polyu.edu.hk/study/ug/fees-and-scholarships/fees', supports: '2026/27学費・年間支出の例' },
    ],
  },
  {
