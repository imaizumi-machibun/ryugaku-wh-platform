...
test('旧purposeは検証済みの吸収先だけ301対象にする', () => {
  ...
  assert.equal(resolveLegacyPurposePath('cuba', 'language'), '/countries/cuba/study-abroad');
  assert.equal(resolveLegacyPurposePath('cuba', 'university'), '/countries/cuba/study-abroad');
